...
/**
 * Vite configuration for building Instagram plugin UI components.
 *
...
export default defineConfig({
  ...
  build: {
    ...
    lib: {
      ...
      name: "InstagramMetaPlugin", // Must match convertPluginIdToGlobalVar("hay-channel-instagram-meta")
      fileName: () => "ui.js",
    },
    outDir: "dist",
    rollupOptions: {
