 ...
 *
 * The plugin worker receives HAY_API_URL and HAY_API_TOKEN env vars
 * from the plugin-runner service. These are used to authenticate
 * requests back to the main server.
 */
